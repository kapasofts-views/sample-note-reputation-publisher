            ...
            <ul class="slides">
                <li>
                    <div class="super-hero-unit">
                        <figure><?php print '<img src="'.base_path() . path_to_theme() .'/img/kapasoft/assets/landscapes/landscape-2-1250x420.jpg" alt="some image">'; ?>
<!--                            <img alt="some image" src="../img/kapasoft/assets/landscapes/landscape-2-1250x420.jpg">-->
        ...
        <div class="row-fluid">
            <div class="span6">
                <div class="flexslider margin-bottom" data-flex-directions="hide" data-flex-speed="10000" id="work">
                    <ul class="slides">
                        <li>
                            <?php print '<img src="'.base_path() . path_to_theme() .'/img/kapasoft/assets/devices/imac-2.png" alt="some image">'; ?>
<!--                            <img alt="some image" src="../img/kapasoft/assets/devices/imac-2.png">-->
                        </li>
                        <li>
                            <?php print '<img src="'.base_path() . path_to_theme() .'/img/kapasoft/assets/devices/macbook.png" alt="some image">'; ?>
<!--                            <img alt="some image" src="../img/kapasoft/assets/devices/macbook.png">-->
                        </li>
                        <li>
                            <?php print '<img src="'.base_path() . path_to_theme() .'/img/kapasoft/assets/devices/ipad.png" alt="some image">'; ?>
<!--                            <img alt="some image" src="../img/kapasoft/assets/devices/ipad.png">-->
                        </li>
                    </ul>
                </div>
            </div>
                    ...
                    <div class="span4">
                        <div class="round-box box-small">
                            <a class="box-inner" href="post.html">
                                <?php print '<img src="'.base_path() . path_to_theme() .'/img/kapasoft/assets/landscapes/landscape-3-300x300.jpg" class="img-circle" alt="some image">'; ?>
<!--                                <img alt="some image" class="img-circle" src="../img/kapasoft/assets/landscapes/landscape-3-300x300.jpg">-->
                            </a>
                        </div>
            ...
            <li class="span4">
                <div class="row-fluid">
                    <div class="span4">
                        <div class="round-box box-small">
                            <a class="box-inner" href="post.html">
                                <?php print '<img class="img-circle" alt="some image" src="'.base_path() . path_to_theme() .'/img/kapasoft/assets/landscapes/landscape-1-300x300.jpg">'; ?>
<!--                                <img alt="some image" class="img-circle" src="../img/kapasoft/assets/landscapes/landscape-1-300x300.jpg">-->
                                <i class="icon-link"></i>
                            </a>
                        </div>
                        <h5 class="text-center light">
            ...
            <li class="span4">
                <div class="row-fluid">
                    <div class="span4">
                        <div class="round-box box-small">
                            <a class="box-inner" href="post.html">
                                <?php print '<img class="img-circle" alt="some image" src="'.base_path() . path_to_theme() .'/img/kapasoft/assets/landscapes/landscape-2-e-300x300.jpg">'; ?>
<!--                                <img alt="some image" class="img-circle" src="../img/kapasoft/assets/landscapes/landscape-2-e-300x300.jpg">-->
                                <i class="icon-play"></i>
                            </a>
                        </div>
                        <h5 class="text-center light">
    ...
    <div class="container-fluid">
        ...
        <div class="flexslider fadein-links" data-flex-animation="slide" data-flex-controls="hide" data-flex-directions-position="outside" data-flex-directions-type="fancy" data-flex-itemwidth="250" data-flex-slideshow="false" id="client">
            <ul class="slides">
                <li>
                    <a href="#">
                        <?php print '<img alt="client" src="'.base_path() . path_to_theme() .'/img/kapasoft/assets/clients/client1.png">'; ?>
<!--                        <img alt="client" src="../img/kapasoft/assets/clients/client1.png">-->
                    </a>
                </li>
                <li>
                    <a href="#">
                        <?php print '<img alt="client" src="'.base_path() . path_to_theme() .'/img/kapasoft/assets/clients/client2.png">'; ?>
<!--                        <img alt="client" src="../img/kapasoft/assets/clients/client2.png">-->
                    </a>
                </li>
                <li>
                    <a href="#">
                        <?php print '<img alt="client" src="'.base_path() . path_to_theme() .'/img/kapasoft/assets/clients/client3.png">'; ?>
<!--                        <img alt="client" src="../img/kapasoft/assets/clients/client3.png">-->
                    </a>
                </li>
                <li>
                    <a href="#">
                        <?php print '<img alt="client" src="'.base_path() . path_to_theme() .'/img/kapasoft/assets/clients/client4.png">'; ?>
<!--                        <img alt="client" src="../img/kapasoft/assets/clients/client4.png">-->
                    </a>
                </li>
                <li>
                    <a href="#">
                        <?php print '<img alt="client" src="'.base_path() . path_to_theme() .'/img/kapasoft/assets/clients/client5.png">'; ?>
<!--                        <img alt="client" src="../img/kapasoft/assets/clients/client5.png">-->
                    </a>
                </li>
                <li>
                    <a href="#">
                        <?php print '<img alt="client" src="'.base_path() . path_to_theme() .'/img/kapasoft/assets/clients/client6.png">'; ?>
<!--                        <img alt="client" src="../img/kapasoft/assets/clients/client6.png">-->
                    </a>
                </li>
                <li>
                    <a href="#">
<!--                        <img alt="client" src="../img/kapasoft/assets/clients/client7.png">-->
                    </a>
                </li>
                <li>
                    <a href="#">
